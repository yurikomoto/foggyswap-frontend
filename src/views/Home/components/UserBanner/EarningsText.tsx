...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Astro pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Astro pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Astro pool', data)
  }
