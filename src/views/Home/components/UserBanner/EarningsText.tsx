...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and WAGYU pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and WAGYU pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from WAGYU pool', data)
  }
