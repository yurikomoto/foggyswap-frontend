...
import masterChef from 'config/abi/AstroFarm.json'
import sousChef from 'config/abi/AstroStakingPool.json'
import sousChefV2 from 'config/abi/AstroStakingPoolInitializable.json'
import sousChefBnb from 'config/abi/VLXStaking.json'
import claimRefundAbi from 'config/abi/claimRefund.json'
import tradingCompetitionAbi from 'config/abi/tradingCompetition.json'
import easterNftAbi from 'config/abi/easterNft.json'
import cakeVaultAbi from 'config/abi/AstroVault.json'
