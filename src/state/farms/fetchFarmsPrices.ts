...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === tokens.ada.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === tokens.ada.symbol) {
...
const getFarmQuoteTokenPrice = (
  ...
  if (quoteTokenFarm.quoteToken.symbol === 'ADA') {
